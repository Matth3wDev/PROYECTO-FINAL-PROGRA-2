...
from torreLlamas import torresLlamas
from torreMisil import torreMisil
from misiles import misiles
from Excepcion_juego import (
    Excepcion_juego,
    ExcepcionRecursosInsuficientes,
    ExcepcionColocacionTorre as ExcepcionColocacionTorreInvalida,  # alias para mantener compatibilidad
)
...
# =========================================================
#  🔧 Gestor de recursos (nuevo en main para evitar fallos)
# =========================================================
...
class DefenseZone3HD:
    def __init__(self):
        ...
        # Inicializar recursos (💰 dinero / ❤️ vidas)
    ...
    def manejar_click_juego(self, x: int, y: int):
        try:
            if self.posicion_valida_torre(x, y):
                ...
                raise ExcepcionColocacionTorreInvalida("No se puede colocar torre en esta posición")
        except ExcepcionColocacionTorreInvalida as e:
    ...
    def actualizar(self, dt: float):
        ...
        # lanzar nueva oleada si corresponde
    ...
    # ================== LOOP ==================
    def ejecutar(self):
        print("Iniciando Defense Zone 3 HD.")
        print("Desarrollado para Universidad Internacional de las Américas")
        print("Proyecto de Programación Orientada a Objetos")
